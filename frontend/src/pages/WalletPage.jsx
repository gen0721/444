...
function BottomModal({ children, onClose }) {
  ...
  return (
    <div ref={overlayRef}
      style={{ position:'fixed', inset:0, background:'rgba(8,10,22,0.99)', backdropFilter:'blur(14px)', zIndex:200, display:'flex', flexDirection:'column' }}>
      <div style={{
        flex:1, display:'flex', flexDirection:'column',
        padding:'0 20px', paddingBottom:'calc(24px + env(safe-area-inset-bottom, 16px))',
