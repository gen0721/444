...
const Product = sequelize.define('Product', {
  ...
  status:        { type: DataTypes.STRING(30), defaultValue: 'active' },  // VARCHAR not ENUM
...
const Deal = sequelize.define('Deal', {
  ...
  status:         { type: DataTypes.STRING(30), defaultValue: 'frozen' },  // VARCHAR not ENUM
...
const Transaction = sequelize.define('Transaction', {
  ...
  type:                { type: DataTypes.STRING(30), allowNull: false },   // VARCHAR not ENUM
  amount:              { type: DataTypes.DECIMAL(12,2), allowNull: false },
  currency:            { type: DataTypes.STRING(10), defaultValue: 'USDT' },
  status:              { type: DataTypes.STRING(20), defaultValue: 'pending' }, // VARCHAR not ENUM
...
const Broadcast = sequelize.define('Broadcast', {
  ...
  targetType:   { type: DataTypes.STRING(20), defaultValue: 'all' },  // VARCHAR not ENUM
...
const Chat = sequelize.define('Chat', {
  ...
  type:            { type: DataTypes.STRING(20), defaultValue: 'public' }, // VARCHAR not ENUM
  ...
  closedReason:    { type: DataTypes.STRING(300), allowNull: true },
